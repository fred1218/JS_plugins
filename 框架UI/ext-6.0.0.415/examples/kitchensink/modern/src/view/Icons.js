        ...
        items: [
            {
                ...
                title  : 'Info',
                cls    : 'card',
                html   : 'Both toolbars and tabbars have built-in, ready to use icons.<br><br><em>We provide over 300 icons that can optionally be included in your app via Sass and Compass.</em>'
            },
            {
                iconCls: 'download',
                title  : 'Download',
