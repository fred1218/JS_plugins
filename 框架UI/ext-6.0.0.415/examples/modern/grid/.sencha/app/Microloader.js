    ...
    var _cache = window['applicationCache'],
        ...
        Asset.prototype = {
            shouldCache: function() {
                return this.assetConfig.update && this.assetConfig.hash && !this.assetConfig.remote;
            },
        ...
        Microloader = {
            ...
            onUpdatedManifestLoaded: function (result) {
                ...
                if (!result.error) {
                    ...
                    Microloader.updatedManifest = false;
                    ...
                    if (!manifest.shouldCache()) {
                        ...
                        //</debug>
                        Microloader.updatedManifest = true;
            ...
            onAllUpdatedAssetsReady: function() {
                ...
                if (Microloader.updatedManifest) {
                    ...
                    if (Microloader.updatedManifest instanceof Manifest) {
                        //<debug>
                        _debug("Manifest was updated, re-caching");
                        //</debug>
                        Ext.manifest = Microloader.updatedManifest.exportContent();
