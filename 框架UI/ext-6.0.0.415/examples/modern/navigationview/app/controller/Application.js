Ext.define('NavigationView.controller.Application', {
    ...
    onContactSelect: function(list, index, node, record) {
        ...
        if (!this.showContact) {
            this.showContact = Ext.create('NavigationView.view.contact.Show');
        }
    ...
    onContactEdit: function() {
        if (!this.editContact) {
            this.editContact = Ext.create('NavigationView.view.contact.Edit');
        }
